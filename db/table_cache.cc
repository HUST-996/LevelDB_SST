...
Status TableCache::FindTable(uint64_t file_number, uint64_t file_size,
  ...
  *handle = cache_->Lookup(key);
  if (*handle == nullptr) {
    ...
    //TODO
    //合并文件
    std::string file1 = TableFileName("/tmp/testdb/stripe1", file_number);
    std::string file2 = TableFileName("/tmp/testdb/stripe2", file_number);
    std::string file3 = TableFileName("/tmp/testdb/stripe3", file_number);
    std::string file4 = TableFileName("/tmp/testdb/stripe4", file_number);
    std::string file5 = TableFileName("/tmp/testdb/stripe5", file_number);
    std::string file6 = TableFileName("/tmp/testdb/stripe6", file_number);
    std::string outputFile = TableFileName("/tmp/merge", file_number);
    file1.erase(26);
